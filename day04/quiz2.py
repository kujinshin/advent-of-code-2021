        ...
        if k not in winning_boards:
            if check_bingo(bingo_boards_visited[k]):
                ...
                if len(winning_boards) == len(bingo_boards):
                    ...
                    last_winning_board = k
                    last_called_number = number
                    break

    if last_winning_board_found:
        break

print(
    get_score(bingo_boards[last_winning_board],
              bingo_boards_visited[last_winning_board], last_called_number))
